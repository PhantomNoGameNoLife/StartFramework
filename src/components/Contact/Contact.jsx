        ...
        <div className="container">
          <div className="dvh-100 d-flex flex-column justify-content-center align-items-center">
            ...
            <form action="" className='p-3 w-100'>
              ...
              <input id='username' className="form-control py-3 border-0 border-bottom w-100" type="text" onChange={(e) => labelTop('user', e)} placeholder="userName" aria-label="User Name"></input>
              ...
              <input id='useremail' className="form-control py-3 border-0 border-bottom w-100" type="email" onChange={(e) => labelTop('email', e)} placeholder="useremail" aria-label="User Email"></input>
              ...
              <button class={`btn mt-4 text-white ${Style.bg}`}>Send Message</button>
            </form>
          </div>
        </div>
      </section>
